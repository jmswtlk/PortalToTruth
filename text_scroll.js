...
['1602 -- Captain Bartholomew Gosnold reached Maine and came south to Cape Cod. Being in the early summer, the area was very pleasant with an abundance of fish. They explored the area and provided some of the names that we use today, such as Cape Cod and Martha\'s Vineyard. Gosnold had enough people with him to start a colony, but most didn’t want to stay in the area given the problems.'],
['1603 -- Start of the reign of James VI & I (1603-1625).'],
['1607 -- Gosnold captained one of the ships that went to Virginia with the intent to settle the area. Hence, we have the story of Jamestown. Gosnold noted that some of the natives had items that indicated the prior visits by Europeans. The group had problems in the beginning; some were on the verge of leaving but reinforcements from England saved the day.'],
['1607 -- About the same time as the Jamestown effort, a group went to Maine under the command of Sir John Popham. This group made some significant strides. They had a fort and other buildings in place. Plus, they built and sailed a ship (a pinnace, named Virginia, which later sailed to Virginia and to England).'],
...
['1614 -- Captain John Smith explored Maine as his men fished the area. Smith was the first to use New England rather than North Virginia. He wrote that there are \“two fishing seasons in the Gulf of Maine\” and suggested fishing stations. Captain John Smith maps out the area of Cape Ann (named by Prince Charles).'],
...
['1621/22/23 -- Who was first? Ferdinando Gorges claimed to have established plantations prior to 1620. Rev. John White began organizing “Dorchester Adventurers” to put a fishing station at Cape Ann. First Thanksgiving held at Plymouth. A small group overwinters at Cape Ann.'], 
['1621 -- Ten to twelve ships are fishing around Monhegan.'],
['1622 -- Wessagusset colony established by Thomas Weston.'],
['Before 1623/24 -- Exploration of the east coast had continued without stop after the 1492 discovery. New England started with the Virginia colony. As well, English ships had been traveling up and down the coast, mapping the area, looking for spots to fish, or to settle.'], 
...
['1623/24 –- Thomas and Margaret arrive with three boys, Thomas, George and Richard. John is born at Cape Ann. Thomas’ group arrived at Cape Ann (J.B. Felt says 1623 while W. Hubbard has a year later) and started to establish themselves. One task was to put together living quarters, such as the frame house for which a lot of the material had been brought on the ship.'],
...
['1623/24 -- Other activities, a very long list, related to settling were accomplished, too. Organizing this activity and securing the provisions brought in the ships would have been on the top of the list for Thomas. Nevertheless, the first winter in Cape Ann would have presented several challenges. The climate differs by a lot from the old country. Yet, nothing of a dire nature was recorded. Thomas, George, and Richard came with their parents. Son, John, was born.'],
...
['1625 -- Communication means were slow. Whatever there may have been must have easily gotten out of sync. Conant at Nantasket, about this time, received notice from White to go to Cape Ann. This request was precipitated, primarily, by Conant’s brother in England and really had not much to do with supposed failure at Cape Ann (that was an ex post facto rationalization – trying to explain the expectations for almost miraculous returns).'],
...
['1626 -- Sir Francis Bacon dies in North London. The group, or part of it, removed to Naumkeag from Cape Ann, and, it was not a one-and-done deal (see Balch leaflets, for example). The two places were not far enough apart to prohibit the group to travel back and forth. There was the big house to care for. Also, there were gardens and other resources. So, back-and-forth would have been the order of the day and would have been taken as normal (hence, no need to document this as unusual).'],
...
['1627 -- Time was spent between Naumkeag and Cape Ann. Too, there may have been some exploration further south and west. Daughter, Sarah, was born. The company reorganized and Endicott was named to be the new boss, on the ground, at Naumkeag. He and his group prepared for departure. France and Spain agree "to fight Protestantism."'],
['1627/28 -- Salem\'s deadly winter. Dr. Samuel Fuller comes up from Plymouth to help.'],
['1628 -- Washington Street laid out in Salem “perpendicular to the old Indian trail.” A new Massachusetts Bay charter is signed by Endicott and others. Craddock, the governor of the company in England, is cousin of Endicott’s wife. Endicott arrives with wife and 30 others, and replaces Conant. Endicott, of course, has to relay the message as there had been no forewarning to Conant.'],    
...
['1629 -- Endicott’s wife died over the winter. Thomas, as Mr. Gardner, is mentioned by a Mr. Webb in a July 28 meeting in London. Webb was reading from a letter sent by Mr. Endicott. Son, Samuel, was born. Naumkeag renamed to Salem (Peace, Hebrew). Higginson shows up with 350 passengers on six ships with some provisions (including cattle), evidently not enough. '],
...
['1637 -- Thomas made Freeman on the 17th of the 3rd month. It’s interesting that he and Hathorne were voted to the General Court as representatives. Thomas, after that, kept a local focus. The place was growing. Salem’s population: 1637 about 900, 1639 about 950, 1644 about 1200, 1654 about 1068, 1665 about 1466.'],
...
['1645 -- Before and after 1641 -- Margaret died. Thomas married Demaris Shattuck (a Quaker). Later, he had sons who were Quakers. Note: Thomas is not mentioned anywhere as being harassed (we’ll go into why this is so, to boot) for his views or his preferences in regard to what he thought about his lifestyle or how to raise his kids. Thomas had several roles (see Great Migration book) in Salem.'],
...
['1680 -- Rev. William died in 1704. His manuscript was almost burned when there was a mob induced fire at the house of Gov. Thomas Hutchinson in 1765. Hubbard\’s narrative was not published until 1815 (Hubbard has an extensive list of references that we need to add to the list and to review).'], 
...
['1736 -- In his look, Thomas Prince provides a broad sweep of history from six days after Creation all the way up to the time of King James VI. His use of New England includes Virginia. There was a lot of activity in the northern region prior to 1620. Prince mentions that Gardner and Tylly oversaw the Cape Ann Plantation (following Rev. Hubbard, of course).'],  
...
['1840s -- Thomas’ grave, along with several others, at Salem’s old burying ground was lost. Some graves were moved to the Trask plot or to Harmony Grove cemetery (the northwest corner – where are the stones?) in order to allow for street expansion. Others who only had their stones moved include Abel (grandson via Samuel) and Abel’s wife (Sarah Porter).'],  
...
['1930 -- George Francis Dow uses his study of the great frame house (by now, demolished due from the ravages of time and the elements – though some of the support structures are said to still be in use in another building in Salem) to construct a fully-dimensioned replica of the house in the Salem Pioneer Village for the 300th Anniversary celebrations.'],
...
['GBIV3,1663 – John and Samue Gardnerl, and others, were granted permission “to build a mill over the South river.”'], 
...
['GBIV4,1671 - Nantucket was to ship “four barrels of merchantable codfish” to New York every year. The town was named Sherburne. '],
